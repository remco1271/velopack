...
public class GiteaDeploymentTests
{
    ...
    public readonly static string GITEA_REPOURL = "https://radiogit.hetronic.nl/remco1271/VelopackGiteaUpdateTest";//"https://gitea.com/remco1271/VelopackGithubUpdateTest.git";
